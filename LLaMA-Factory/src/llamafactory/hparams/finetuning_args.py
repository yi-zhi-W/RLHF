...
class RLHFArguments:
    ...
    grpo_num_generations: int | None = field(
        default=8,
        metadata={
    ...
    grpo_max_completion_length: int | None = field(
        default=256,
        metadata={"help": "Maximum length of the generated completion."},
    )

    grpo_shuffle_dataset: bool | None = field(
        default=True,
    ...
    grpo_importance_sampling_level: str = field(
        default="token",
        metadata={
...
class FinetuningArguments(
    ...
    finetuning_type: Literal["lora", "freeze", "full", "mtllora", "basemtllora", "combinedmtllora", "comscalmtllora", "gatemtllora", "multilora", "hydralora", "moelora", "hdmolelora", "combroutemtllora"] = field(
        default="lora",
    ...
    def __post_init__(self):
        ...
        assert self.finetuning_type in ["lora", "mtllora", "basemtllora", "combinedmtllora", "comscalmtllora", "gatemtllora", "multilora", "hydralora", "moelora", "hdmolelora", "combroutemtllora", "freeze", "full"], "Invalid fine-tuning method."
