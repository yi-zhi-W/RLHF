...
def _verify_model_args(
    ...
    if model_args.adapter_name_or_path is not None:
        if finetuning_args.finetuning_type != "lora" and finetuning_args.finetuning_type != "mtllora" and finetuning_args.finetuning_type != "basemtllora" and finetuning_args.finetuning_type != "combinedmtllora" and finetuning_args.finetuning_type != "comscalmtllora"  and finetuning_args.finetuning_type != "gatemtllora" and finetuning_args.finetuning_type != "multilora" and finetuning_args.finetuning_type != "combroutemtllora" and finetuning_args.finetuning_type != "hydralora" and finetuning_args.finetuning_type != "moelora" and finetuning_args.finetuning_type != "hdmolelora":
...
def get_infer_args(args: Optional[Union[dict[str, Any], list[str]]] = None) -> _INFER_CLS:
    ...
    if model_args.export_dir is not None and model_args.export_device == "cpu":
        ...
        if data_args.cutoff_len != DataArguments().cutoff_len:  # override cutoff_len if it is not default
            model_args.model_max_length = data_args.cutoff_len
            print("set model_args.model_max_length to", data_args.cutoff_len)
    else:
